...
class JSONVacancyStorage(VacancyStorage):
    """
    Этот класс дает функциональность для работы с JSON файлами,
    нужных для хранения данных о вакансиях.
    """
    ...
    def get_vacancies_by_keywords(self, keywords: List[str]) -> List[Vacancy]:
        """Получать все вакансии из файла по ключевому слову в атрибуте description"""
        vacancies = self._load_vacancies()
        result = []
