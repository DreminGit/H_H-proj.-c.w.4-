...
def user_interaction() -> None:
    """
    Функция взаимодействия с пользователем. Создает экземпляр класса Vacancy и.
    В зависимости от выбора пользователя переходит к запуску
...
def menu_top_n_vac(json_storage: JSONVacancyStorage) -> None:
    """
    Доп. функция взаимодействия с пользователем при выборе 'Вывод топ N вакансий по зарплате'
...
def menu_get_vac_for_keyword(json_storage: JSONVacancyStorage) -> None:
    """
    Дополнительная функция для взаимодействия с пользователем при выборе 'Получить вакансии с ключевым словом в описании'
    """
...
def menu_delete_vacancy(json_storage: JSONVacancyStorage) -> None:
    """
    Дополнительная функция для взаимодействия с пользователем при выборе 'Удалить вакансию'
    """
...
def menu_get_vac_for_salary(json_storage: JSONVacancyStorage) -> None:
    """
    Дополнительная функция для взаимодействия с пользователем при выборе 'Получить вакансии по желаемой зарплате'
    """
